...
/** Payment-owned Outbox row with lease/retry state for at-least-once delivery. */
@Entity
...
public class PaymentOutboxEvent {
    ...
    public PaymentOutboxEvent(String aggregateId, String eventType, String payloadJson) {
